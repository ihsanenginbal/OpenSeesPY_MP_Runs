...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Lengths=np.array([3.20, 2.20, 2.70, 2.20, 3.20])*fac[3]
    ...
    Heights=np.array([3.0*fac[4], 3.0, 3.0, 3.0, 3.0, 3.0, 3.0, 3.0])
    ...
    N0=np.array([[-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.9, -2.8, -9.7, -9.7, -2.8, -6.9],
                    [-6.6, -2.4, -9.4, -9.4, -2.4, -6.6]])*fac[3]
    ...
    Wz=np.array([[-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.9, -8.5, -7.3, -8.5, -6.9],
                    [-6.6, -8.3, -7.1, -8.3, -6.6]])*(1+(fac[3]-1)/2)
    ...
    Col_Widths=np.array([0.25, 0.25, 1.00, 0.25, 0.25, 0.90, 0.25, 0.80])
    Col_Depths=np.array([1.05, 1.05, 0.25, 0.95, 0.95, 0.25, 0.80, 0.25])*fac[5]
    ...
    Col_Rebars=[ [5, fi16, 3, 2, fi14, 3, 4, fi14, 3, 2, fi14, 3, 5, fi16, 3],
                    ...
                    [14, fi8, 3, 2, fi16, 3, 2, fi16, 3, 2, fi16, 3, 14, fi8, 3],
                    [4, fi16, 3, 2, fi14, 3, 2, fi14, 3, 2, fi14, 3, 4, fi16, 3],
                    [5, fi16, 3, 2, fi14, 3, 0, fi14, 3, 2, fi14, 3, 5, fi16, 3],
                    [14, fi8, 3, 0, fi14, 3, 2, fi16, 3, 0, fi14, 3, 14, fi8, 3],
                    [3, fi16, 3, 2, fi14, 3, 0, fi14, 3, 2, fi14, 3, 3, fi16, 3],
                    [10, fi8, 3, 0, fi14, 3, 2, fi16, 3, 0, fi14, 3, 10, fi8, 3]]
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [4, fi16, 3, 4, fi8, 3, 0, 0, 0, 2, fi16, 3],
                    [4, fi8, 3, 2, fi8, 3, 0, 0, 0, 2, fi8, 3]]
