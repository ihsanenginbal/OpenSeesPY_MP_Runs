...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Heights=np.array([3.0/fac[5]*fac[4], 3.0, 3.0, 3.0])*fac[5]
    ...
    N0=np.array([[-40.72, -49.94, -28.10],
                    [-40.72, -49.94, -28.10],
                    [-40.72, -49.94, -28.10],
                    [-34.80, -38.06, -22.20] ])*fac[3]
    ...
    Col_Widths=np.array([0.30, 1.40])
    Col_Depths=np.array([0.55, 0.20])
    ...
    Col_Rebars=[ [14, fi16, 3, 0, fi14, 3, 0, fi14, 3, 0, fi14, 3, 14, fi16, 3],
                    [14, fi16, 3, 0, fi14, 3, 0, fi14, 3, 0, fi14, 3, 14, fi16, 3]]
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [2, fi12, 3, 0, fi8, 3, 0, fi18, 3, 3, fi12, 3],
                    [2, fi12, 3, 4, fi8, 3, 0, fi12, 0, 2, fi16, 3]]
