...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Heights=np.array([3.0/fac[5]*fac[4], 3.0, 3.0, 3.0, 3.0])*fac[5]
    ...
    N0=np.array([[-46.48, -43.52, -43.52, -43.52, -46.48],
                    [-46.48, -43.52, -43.52, -43.52, -46.48],
                    [-46.48, -43.52, -43.52, -43.52, -46.48],
                    [-46.48, -43.52, -43.52, -43.52, -46.48],
                    [-46.48, -43.52, -43.52, -43.52, -46.48] ])*fac[3]
    ...
    Wz=np.array([[-11.00, -11.00, -11.00, -11.00],
                    [-11.00, -11.00, -11.00, -11.00],
                    [-11.00, -11.00, -11.00, -11.00],
                    [-11.00, -11.00, -11.00, -11.00],
                    [-11.00, -11.00, -11.00, -11.00]])*(1+(fac[3]-1)/2)
