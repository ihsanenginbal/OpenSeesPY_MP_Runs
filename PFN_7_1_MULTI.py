...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Lengths=np.array([3.85, 3.75, 3.40])*fac[3]
    ...
    Heights=np.array([2.9/fac[5]*fac[4], 2.9, 2.9, 2.9, 2.9, 2.9, 2.9])*fac[5]
    ...
    N0=np.array([[-15.3, -9.7, -11.04, -12.20],
                    [-15.3, -9.7, -11.04, -12.20],
                    [-15.3, -9.7, -11.04, -12.20],
                    [-15.3, -9.7, -11.04, -12.20],
                    [-12.2, -11.8, -11.8, -12.2],
                    [-12.2, -11.8, -11.8, -12.2],
                    [-12.2, -11.8, -11.8, -12.2] ])*fac[3]
    ...
    Wz=np.array([[-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18],
                    [-30.17, -21.18, -21.18] ])*(1+(fac[3]-1)/2)
    ...
    Col_Widths=np.array([0.50, 0.50, 0.70, 0.45, 0.50, 0.40, 0.35, 0.35, 0.30, 0.25])
    Col_Depths=np.array([0.30, 0.30, 0.30, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25, 0.25])
    ...
    Col_Rebars=[ [2, fi16, 3, 0, fi16, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3],
                    [2, fi16, 3, 2, fi14, 3, 0, fi16, 3, 2, fi16, 3, 2, fi16, 3],
                    [3, fi16, 3, 2, fi14, 3, 0, fi16, 3, 2, fi16, 3, 3, fi16, 3],
                    [2, fi16, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3, 2, fi16, 3],
                    [2, fi16, 3, 0, fi16, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3],
                    [2, fi14, 3, 0, fi14, 3, 2, fi14, 3, 0, fi14, 3, 2, fi14, 3],
                    [2, fi16, 3, 0, fi14, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3],
                    [2, fi14, 3, 0, fi14, 3, 2, fi14, 3, 0, fi14, 3, 2, fi14, 3],
                    [2, fi14, 3, 0, fi14, 3, 0, fi14, 3, 0, fi14, 3, 2, fi14, 3],
                    [2, fi14, 3, 0, fi14, 3, 0, fi14, 3, 0, fi14, 3, 2, fi16, 3] ]
    ...
    Bs=[0.60, 0.60, 1.00, 1.00]

    # Beam width at the bottom (m)
    Bw=[0.15, 0.15, 0.25, 0.25]
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [4, fi12, 3, 3, fi8, 3, 0, fi18, 3, 2, fi14, 3],
                    [2, fi10, 3, 3, fi8, 3, 0, fi12, 0, 4, fi14, 3],
                    [4, fi12, 3, 4, fi8, 3, 0, fi12, 0, 2, fi14, 3],
                    [3, fi10, 3, 4, fi8, 3, 0, fi12, 0, 3, fi14, 3]]
