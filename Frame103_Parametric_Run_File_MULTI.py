...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Lengths=np.array([3.50, 5.25, 4.45, 5.25, 3.50])*fac[3]

    # Clear length of left and right balconies in m (zero if doesnt exist)
    Left_Right_Balconies=[1.50, 1.50]
    ...
    N0=np.array([[-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.8, -15.7, -12.3, -12.3, -15.7, -5.8],
                    [-5.6, -15.3, -12.1, -12.1, -15.3, -5.6]])*fac[3]
    ...
    Wz=np.array([[-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-6.2, -16.9, -14.3, -16.9, -6.2],
                    [-5.9, -16.3, -14.1, -16.3, -5.9]])*(1+(fac[3]-1)/2)
    ...
    Col_Widths=np.array([0.25, 1.60, 0.50, 0.25, 0.50, 0.25, 1.60, 0.50])
    Col_Depths=np.array([0.50, 0.25, 0.80, 0.45, 0.70, 0.40, 0.25, 0.60])*fac[5]
    ...
    Col_Rebars=[ [2, fi16, 3, 0, fi16, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3],
                    [9, fi16, 3, 2, fi16, 3, 2, fi16, 3, 2, fi16, 3, 9, fi16, 3],
                    [6, fi16, 3, 4, fi16, 3, 4, fi16, 3, 4, fi16, 3, 6, fi16, 3],
                    [2, fi16, 3, 0, fi16, 3, 2, fi16, 3, 0, fi16, 3, 2, fi16, 3],
                    [4, fi16, 3, 4, fi16, 3, 4, fi16, 3, 4, fi16, 3, 4, fi16, 3],
                    [6, fi16, 3, 4, fi16, 3, 4, fi16, 3, 4, fi16, 3, 6, fi16, 3],
                    [8, fi16, 3, 2, fi16, 3, 2, fi16, 3, 2, fi16, 3, 8, fi16, 3],
                    [2, fi16, 3, 4, fi16, 3, 4, fi16, 3, 4, fi16, 3, 2, fi16, 3]]
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [3, fi16, 3, 4, fi8, 3, 0, 0, 0, 2, fi16, 3],
                    [8, fi16, 3, 10, fi8, 3, 0, 0, 0, 4, fi16, 3]]
