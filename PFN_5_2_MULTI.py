...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Lengths=np.array([4.00, 4.00, 4.00, 4.00])*fac[3]
    ...
    Heights=np.array([4.5/fac[5]*fac[4], 3.0, 3.0, 3.0, 3.0])*fac[5]
    ...
    N0=np.array([[-56.10, -61.40, -61.40, -61.40, -56.10],
                    [-54.50, -58.50, -58.50, -58.50, -58.50],
                    [-54.50, -58.50, -58.50, -58.50, -58.50],
                    [-54.50, -58.50, -58.50, -58.50, -58.50],
                    [-54.50, -58.50, -58.50, -58.50, -58.50] ])*fac[3]
    ...
    Col_Widths=np.array([0.30, 0.30])
    Col_Depths=np.array([0.40, 0.40])
    ...
    Col_Rebars=[ [3, fi14, 3, 0, fi14, 3, 2, fi14, 3, 0, fi14, 3, 3, fi14, 3],
    ...
    Hb=[0.38, 0.38, 0.38, 0.38]

    # Effective slab width (m)
    Bs=[0.70, 0.70, 0.70, 0.70]
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [8, fi10, 3, 6, fi8, 3, 0, fi18, 3, 2, fi12, 3],
                    [7, fi12, 3, 6, fi8, 3, 0, fi12, 0, 3, fi12, 3],
                    [5, fi12, 3, 6, fi8, 3, 0, fi12, 0, 2, fi12, 3],
                    [6, fi12, 3, 6, fi8, 3, 0, fi12, 0, 3, fi12, 3]]
