...
def eq_analysis(fac,filename,pid,record_no,dt_input):
    ...
    Lengths=np.array([3.00, 3.00, 3.00])*fac[3]
    ...
    Heights=np.array([2.8/fac[5]*fac[4], 2.8, 2.8, 2.8])*fac[5]
    ...
    N0=np.array([[-28.20, -28.20, -28.20, -12.40],
                    [-28.20, -28.20, -28.20, -12.40],
                    [-28.20, -28.20, -28.20, -12.40],
                    [-28.20, -28.20, -28.20, -12.40] ])*fac[3]
    ...
    Col_Widths=np.array([0.25])
    Col_Depths=np.array([0.25])
    ...
    #       Number of Bottom Rebars    , Diameter, MatTag
    Beam_Rebars=[ [5, fi12, 3, 6, fi8, 3, 0, fi18, 3, 4, fi12, 3],
                    [6, fi10, 3, 6, fi8, 3, 0, fi12, 0, 4, fi12, 3],
                    [4, fi12, 3, 6, fi8, 3, 0, fi12, 0, 4, fi12, 3]]
